...
public class Example
{
    ...
    private static void Display(Piligrimm.Structures.LinkedList<string> words, string test)
    {
    ...
    private static void IndicateNode(Piligrimm.Structures.LinkedListNode<string> node, string test)
    {
        Console.WriteLine(test);
...
//Exception message: The Piligrimm.Structures.LinkedList node belongs a Piligrimm.Structures.LinkedList.
